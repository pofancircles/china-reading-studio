...
objectives 返回 2-4 条；objectives 和每段 objective 都必须是简短、可观察的动作短语，并以可观察动作开头，只使用“找出、圈出、说出、回答、复述、比较、排序、匹配、填写、造句、描述、总结”等动作，例如“找出人物和时间”“用三句话复述”。不要只写“理解、掌握、了解”，也不要以“学习、理解、掌握、了解、认识、运用”开头；不要写“学生能够”“教师引导”等教案腔。
